...
wget https://github.com/OctoPrint/OctoPrint/archive/refs/tags/1.9.2.zip -P /root
unzip /root/1.9.2.zip -d /root
cd /root/OctoPrint-1.9.2
python /root/OctoPrint-1.9.2/setup.py install 
